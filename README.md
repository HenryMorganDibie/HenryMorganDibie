...
**ML Systems Engineer · Agentic AI · Credit Risk & Quant Analytics**
...
dbt, Prefect, PySpark, SFTP ingestion pipelines, Snowflake Semantic Layer + dbt MetricFlow, macroeconomic data extraction across 54 African countries. gRPC monorepo refactoring for production-scale data acquisition. I connect pipelines to decision surfaces.
...
**Infrastructure:** Azure · AWS · GCP · FastAPI · gRPC · Docker · Firebase · SQLAlchemy · REST APIs
